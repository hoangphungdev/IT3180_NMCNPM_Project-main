...
const ConfirmRecipeModal = (props) => {
    ...
    const AndroidButtonBox = () => {
        const buttons = [
            { text: 'Hủy bỏ' },
            { text: 'Xác nhận', func: () => { confirmChange() } }
        ];
        ...
        >
            ...
            <View style={styles.alertBox}>
                <View style={[styles.androidAlertBox, styles.container]}>
                    ...
                    <Text style={styles.message}>{'Bạn có chắc muốn thêm phiếu thu ?'}</Text>
                    <AndroidButtonBox />
                </View>
            </View>
        </Modal>
...
export default ConfirmRecipeModal
